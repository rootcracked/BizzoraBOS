            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <label className="flex flex-col">
                ...
                <input
                  ...
                  className="h-10 w-[400px] rounded-lg border border-border-light dark:border-gray-700 bg-white dark:bg-background-dark text-[#111418] dark:text-white placeholder:text-text-light/70 p-2 text-sm focus:outline-none focus:ring-2 focus:ring-secondary/50"
                />
              </label>

              {/** Username */}
              <label className="flex flex-col">
                <span className="text-[#111418] dark:text-white text-sm font-medium pb-1">Username</span>
                <input
                  type="text"
                  name="username"
              ...
              {/** Company Name */}
              <label className="flex flex-col">
                <span className="text-[#111418] dark:text-white text-sm font-medium pb-1">Busines Name</span>
            <input
                className="h-10 w-[400px] rounded-lg border border-border-dark dark:border-gray-700 bg-white dark:bg-background-dark text-[#111418] dark:text-white placeholder:text-text-light/70 p-2 text-sm focus:outline-none focus:ring-2 focus:ring-secondary/50"
